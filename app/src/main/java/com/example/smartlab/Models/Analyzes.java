...
public class Analyzes {
    ...
    public Analyzes(int id_analyzes, int id_categories_of_analyses, String title, String preparation, String biomaterial, int price, int id_stocks, int period_of_execution) {
