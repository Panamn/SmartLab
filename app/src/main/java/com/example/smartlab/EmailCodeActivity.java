        ...
        supaBaseClient.verifyOtp(email, code, new SupaBaseClient.SBC_Callback() {
            ...
            public void onFailure(IOException e) {
                runOnUiThread(() -> {
                    ...
                    Toast.makeText(EmailCodeActivity.this, getString(R.string.text_validate_error), Toast.LENGTH_LONG).show();
                });
    ...
    private void startCountdownTimer() {
        countDownTimer = new CountDownTimer(TIMER_DURATION, 1000) {
            ...
            public void onFinish() {
                ...
                resendText.setTextColor(ContextCompat.getColor(EmailCodeActivity.this, R.color.black));
